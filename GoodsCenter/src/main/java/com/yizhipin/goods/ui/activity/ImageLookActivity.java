...
public class ImageLookActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vp.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position1) {//左右滑动时更新中心点和文字信息
                ...
                vp_text.setText((position1 + 1) + "/" + size);
            }
    ...
    private void initData() {
        ...
        for (int i = 0; i < urls.size(); i++)//获取图片，设置PhotoView，加到ViewPager当中
        {
            ...
            imageLoader.displayImage(urls.get(i), photoView, options);
            imageViews.add(photoView);
        }
        vp.setAdapter(adapter);
        vp.setCurrentItem(position, true);
        vp_text.setText((position + 1) + "/" + size);
    ...
    public void finish() {
        ...
        scaleAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ...
                ImageLookActivity.super.finish();//动画结束时调用Activity的finish方法
