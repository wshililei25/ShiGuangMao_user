...
class HeaderBar @JvmOverloads constructor(
    ...
    init {
        ...
        mBgColor = typeArray.getColor(R.styleable.HeaderBar_bg, ContextCompat.getColor(context, R.color.yWhite))
        mTitleTextColor = typeArray.getColor(R.styleable.HeaderBar_titleTextColor, ContextCompat.getColor(context, R.color.yBlack))
        mRightTextColor = typeArray.getColor(R.styleable.HeaderBar_rightTextColor, ContextCompat.getColor(context, R.color.yBlack))
        mBackImage = typeArray.getResourceId(R.styleable.HeaderBar_backImage, R.drawable.leftarrow)
        initView()
    }
